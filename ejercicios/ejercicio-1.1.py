...
diferencia_con_min =  100 - round(dalto_curso / otros_cursos_min, 1) 
diferencia_con_max = 100 - round(dalto_curso / otros_cursos_max)
diferencia_con_promedio = 100 - round(dalto_curso / otros_cursos_promedio)

#Calculando el porcentaje de tiempo vacìo removido
tiempo_vacio_promedio =  100 - round(otros_cursos_promedio / crudo_promedio)
tiempo_vacio_dalto =  100 - round(dalto_curso / crudo_dalto)
